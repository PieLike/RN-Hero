...
public class HeroMove : MonoBehaviour
{
    ...
    {    
        ...
        if (Input.GetMouseButton(0) && UIClick.OnMouseDown() && MainVariables.inSpelling == false && MainVariables.inInterface == false && Interaction.supposedInteractionObject == null)
        {
            FindFinalPoint();   //на всйкий случай находим FinalPoint (еси она уже найдена то он не будет заного искать)                        
            if (objFinalPoint != null)
            {
