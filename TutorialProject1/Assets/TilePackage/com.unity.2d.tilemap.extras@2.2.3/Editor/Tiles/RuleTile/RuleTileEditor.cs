...
namespace UnityEditor
{
    ...
    public class RuleTileEditor : Editor
    {
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent tilingRulesPosition = EditorGUIUtility.TrTextContent("Position"
                , "The Position Type for the Tile which fits this Rule");
            public static readonly GUIContent tilingRulesScale = EditorGUIUtility.TrTextContent("Scale"
                , "The Scale Type for the Tile which fits this Rule");
        ...
        public float GetElementHeight(RuleTile.TilingRule rule)
        {
            ...
            float matrixHeight = GetMatrixSize(bounds).y + 10f + 30f;
        ...
        private void OnAddElement(object obj)
        {
            ...
            rule.m_GameObjectScale = tile.m_DefaultGameObjectScale;
            rule.m_GameObjectPosition = tile.m_DefaultGameObjectPosition;
        ...
        public override void OnInspectorGUI()
        {
            ...
            tile.m_DefaultGameObjectScale = new Vector3(1f,1f,1f);
            tile.m_DefaultGameObjectPosition = new Vector3(0f,0f,0f);
        ...
        public void RuleInspectorOnGUI(Rect rect, RuleTile.TilingRuleOutput tilingRule)
        {
            ...
            y += k_SingleLineHeight;
            GUI.Label(new Rect(rect.xMin, y, k_LabelWidth, k_SingleLineHeight), Styles.tilingRulesScale);
            tilingRule.m_GameObjectScale = (Vector3)EditorGUI.Vector3Field(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), "",tilingRule.m_GameObjectScale);
            y += k_SingleLineHeight;
            GUI.Label(new Rect(rect.xMin, y, k_LabelWidth, k_SingleLineHeight), Styles.tilingRulesPosition);
            tilingRule.m_GameObjectPosition = (Vector3)EditorGUI.Vector3Field(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), "",tilingRule.m_GameObjectPosition);
            y += k_SingleLineHeight;
