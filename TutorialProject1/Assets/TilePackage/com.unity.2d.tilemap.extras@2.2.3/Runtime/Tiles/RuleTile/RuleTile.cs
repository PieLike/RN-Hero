...
namespace UnityEngine
{
    ...
    public class RuleTile : TileBase
    {
        ...
        /// its neighbors.
        /// </summary>
        public Vector3 m_DefaultGameObjectScale, m_DefaultGameObjectPosition;
        ...
        public class TilingRuleOutput
        {
            ...
            /// </summary>
            public Vector3 m_GameObjectScale, m_GameObjectPosition;
        ...
        public class TilingRule : TilingRuleOutput
        {
            ...
            public TilingRule Clone()
            {
                TilingRule rule = new TilingRule
                {
                    ...
                    m_GameObjectScale = m_GameObjectScale,
                    m_GameObjectPosition = m_GameObjectPosition,
                };
            ...
            if (instantiatedGameObject != null)
            {
                ...
                foreach (TilingRule rule in m_TilingRules)
                {
                    if (RuleMatches(rule, position, tilemap, ref transform))
                    {
                        ...
                        gameObjectTranslation = new Vector3(transform.m03, transform.m13+rule.m_GameObjectPosition.y, transform.m23);
                        ...
                        gameObjectScale = rule.m_GameObjectScale; //transform.lossyScale; 
        ...
        public override void GetTileData(Vector3Int position, ITilemap tilemap, ref TileData tileData)
        {
            ...
            //tileData.gameObjectScale = m_DefaultGameObjectScale;
            ...
            foreach (TilingRule rule in m_TilingRules)
            {
                if (RuleMatches(rule, position, tilemap, ref transform))
                {
                    ...
                    //Debug.Log(m_DefaultGameObjectScale.ToString());
                    //transform = Matrix4x4.Scale(m_DefaultGameObjectScale);
                    tileData.transform = transform;
                    //rule.m_GameObject.transform.localScale = m_DefaultGameObjectScale;
                    tileData.gameObject = rule.m_GameObject;
                    //Debug.Log(tileData.gameObject.transform.localScale.ToString());
